...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR / 'templates', BASE_DIR / 'erp_sales' / 'templates'],
...
# Database - Using SQLite for Replit environment
DATABASES = {
    'default': {
...
# Ensure Django can serve the built React assets.
# We copy the React build output into: backend/erp_sales/static/frontend/
STATICFILES_DIRS = [
    BASE_DIR / 'static',
    BASE_DIR / 'erp_sales' / 'static',
]

if not (BASE_DIR / 'static').exists():
    STATICFILES_DIRS = [BASE_DIR / 'erp_sales' / 'static']

# Templates (needed to serve the React index.html)
...
# Channels - Using in-memory layer for Replit environment
CHANNEL_LAYERS = {
    'default': {
